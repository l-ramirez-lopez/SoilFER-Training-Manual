...
```{r child="../SoilFER-Training-Resources/02_scripts/module3/_setup_chunk_ch3.Rmd"}
```
...
## SESSION 1: Data Preparation, Feature Selection, Modelling, and Accuracy Assessment {-}
...
## Section 3 — Load and transform soil data {-}
...
### 3.1 Estimate bulk density with a pedotransfer function {-}
...
## Section 4 — Merge soil data and covariate values {-}
...
## Section 6 — Train the Quantile Regression Forest model {-}

### 6.1 From Random Forest to Quantile Regression Forest {-}
...
## SESSION 2: Spatial Prediction and Final Maps {-}
...
### 8.2 Prepare model for prediction {-}
